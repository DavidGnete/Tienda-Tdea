  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 animate-pulse">
      ...
      <div className="space-y-4">
        ...
        <div className="h-14 w-full rounded-full bg-muted" />
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      {!isLoading && !error && product && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Columna izquierda — Slideshow */}
          <ImageSlideshow images={product.images} alt={product.title} />
          ...
          <div className="flex flex-col">
            ...
            <Button
              asChild
              size="lg"
              className="w-full mt-6 rounded-full h-14 text-base font-semibold gap-2"
            >
